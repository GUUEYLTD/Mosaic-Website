...
<head>
    <meta charset="UTF-8">
    <title>Policies & Procedures Module | Mosaic</title>
  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/policiesAndProcedures/policies-and-procedures.gif" class="img-responsive" />
        </div>

        <div class="col-md-8">
          <h1>Policies & Procedures</h1>
          <h3>
            What is the Policies & Procedures Module?
          </h3>
          <p>Policies & Procedures - A place to keep all your policy & procedure documents for reduced paperwork, organised storage & increased compliance. </p>
