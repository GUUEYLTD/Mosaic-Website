  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/training/training.gif" class="img-responsive" />
        </div>
        ...
        <div class="col-md-8">
          ...
          <p>An e-learning platform for training your staff in all aspects of care, using vibrant & engaging course content to ensure staff retain the information learnt. Records are stored within the module so you can readily keep track of your staff training.</p>
