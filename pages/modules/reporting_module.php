...
<head>
    <meta charset="UTF-8">
    <title>Reporting Module | Mosaic</title>
  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/reporting/reporting.gif" class="img-responsive" />
        </div>
        ...
        <div class="col-md-8">
          ...
          <p>Create fast, easy, accurate and detailed reports in all aspects of your care home. Save time and money with a professional reporting framework.  </p>
