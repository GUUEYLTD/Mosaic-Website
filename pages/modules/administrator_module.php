...
<head>
    <meta charset="UTF-8">
    <title>Administration Module | Mosaic</title>
  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/administrator/administration.gif" class="img-responsive" />
        </div>
        ...
        <div class="col-md-8">
          ...
          <p>Easily manage all the data and information related to the service users, staff and home. Reduce the administrative pressure by having simple, streamlined processes which will result in a more efficient business.</p>
