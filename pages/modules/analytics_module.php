...
<head>
    <meta charset="UTF-8">
    <title>Analytics Module | Mosaic</title>
  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/analytics/analytics.gif" class="img-responsive" />
        </div>
        ...
        <div class="col-md-8">
          ...
          <p>Analyse your data to give you deeper insights into how your care home is operating so you can improve processes, saving time & money.</p>
