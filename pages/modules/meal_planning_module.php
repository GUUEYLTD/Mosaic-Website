...
<head>
    <meta charset="UTF-8">
    <title>Meal Planning Module | Mosaic</title>
  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/mealPlanning/meal-planning.gif" class="img-responsive" />
        </div>

        <div class="col-md-8">
          <h1>Meal Planning</h1>
          <h3>
            What is the Meal Planning Module?
          </h3>
          <p>An easy way to meet the nutritional needs of your residents. The Meal Planner assists staff in preparing a quality menu as well as kitchen management.</p>
