  ...
  <div class="container-background-grey">
    <div class="container-fluid single-module-header">
      <div class="row equal">
        ...
        <div class="col-md-4">
          <img src="/assets/images/productIcons/png/medication/medication.gif" class="img-responsive" />
        </div>
        ...
        <div class="col-md-8">
          ...
          <p>Keep track of service users daily medication with easy processes and real time push notifications to minimise errors. Our e-Mar charts reduce paperwork & increase efficiency and service user safety.</p>
